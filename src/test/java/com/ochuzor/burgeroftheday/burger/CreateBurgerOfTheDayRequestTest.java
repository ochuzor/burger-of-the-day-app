...
class CreateBurgerOfTheDayRequestTest {
  ...
  void validRequestHasNoConstraintViolations() {
    var request =
        new CreateBurgerOfTheDayRequest(
            "Pickled Burger\nComes with pickles", "A briny burger idea.", LocalDate.of(2026, 8, 9));
  ...
  void blankTextRequestIsRejected() {
    var request =
        new CreateBurgerOfTheDayRequest("   ", "A briny burger idea.", LocalDate.of(2026, 8, 9));
  ...
  void textOf150CharactersIsAccepted() {
    ...
    var request =
        new CreateBurgerOfTheDayRequest(text, "A briny burger idea.", LocalDate.of(2026, 8, 9));
  ...
  void nullCommentaryRequestIsAccepted() {
    var request =
        new CreateBurgerOfTheDayRequest(
            "Pickled Burger\nComes with pickles", null, LocalDate.of(2026, 8, 9));
  ...
  void commentaryOver500CharactersIsRejected() {
    ...
    var request =
        new CreateBurgerOfTheDayRequest("A valid burger", commentary, LocalDate.of(2026, 8, 9));
  ...
  void missingPublicationDateIsRejected() {
    var request = new CreateBurgerOfTheDayRequest("Cheesy Burger", "Comes with cheesy jokes", null);
